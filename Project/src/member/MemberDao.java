...
public class MemberDao {
 ...
 public void insertMember(MemberBean mbean){
  ...
  try {
   ...
   pstmt.setString(9, mbean.getEmail2()); 
   pstmt.setString(10, mbean.getPhone1()); 
   pstmt.setString(11, mbean.getPhone2()); 
   pstmt.setString(12, mbean.getPhone3()); 
   pstmt.setString(13, mbean.getIntroduce()); 
 ...
 public Vector<MemberBean> getAllMember(){
  ...
  MemberBean bean;
   ...
   while(rs.next()){
    ...
    bean.setEmail2(rs.getString(9));;    
    bean.setPhone1(rs.getString(10));
    bean.setPhone2(rs.getString(11));
    bean.setPhone3(rs.getString(12));
 ...
 public MemberBean getOneMember(String id){
  ...
  // 회원 정보 수정
 public void updateMember(String id , String address, String email, String email2, String name,
		 					String phone1, String phone2, String phone3, String introduce){

   try {

    con();
   // 쿼리준비
   String sql="update member set address=?, email=?, email2=?, name=?, phone1=?, phone2=?, phone3=?, introduce=? where id=?";
   // 쿼리를 실행할수 있는 객체 생성
   pstmt = con.prepareStatement(sql);
